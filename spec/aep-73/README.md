...
3. An option to sign up to be notified when a new update drops. Doing so, will fire off an email to the user at the email address that they are registered in Console with. 
4. (Ideally) the ability for the user to provide feedback about each new feature

### Implementation

There are a couple options for how the content can be managed.
